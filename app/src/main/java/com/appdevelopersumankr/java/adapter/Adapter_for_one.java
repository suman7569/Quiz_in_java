...
public class Adapter_for_one extends RecyclerView.Adapter<Adapter_for_one.ViewHolder> {
    View v;
    ...
    public Adapter_for_one(View v) {
        this.v = v;
    }

    public Adapter_for_one(String[] levelname) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
           ...
           // Toast.makeText ( itemView.getContext (), "Level "+j, Toast.LENGTH_LONG ).show ();
            switch (i){
                case 0:
                    Intent intent = new Intent ( itemView.getContext (), beg_1.class );
                    itemView.getContext ().startActivity ( intent );
                    break;
                case 1:
                    Intent intent2 = new Intent ( itemView.getContext (), beg_2.class );
                    itemView.getContext ().startActivity ( intent2 );
                    break;
                case 2:
                    Intent intent3 = new Intent ( itemView.getContext (), beg_3.class );
                    itemView.getContext ().startActivity ( intent3 );
                    break;
                case 3:
                    Intent intent4 = new Intent ( itemView.getContext (), beg_4.class );
                    itemView.getContext ().startActivity ( intent4 );
                    break;
                case 4:
                    Intent intent5 = new Intent ( itemView.getContext (), beg_5.class );
                    itemView.getContext ().startActivity ( intent5 );
                    break;
                case 5:
                    Intent intent6 = new Intent ( itemView.getContext (), beg_6.class );
                    itemView.getContext ().startActivity ( intent6 );
                    break;
                case 6:
                    Intent intent7 = new Intent ( itemView.getContext (), beg_7.class );
                    itemView.getContext ().startActivity ( intent7 );
                    break;
                case 7:
                    Intent intent8 = new Intent ( itemView.getContext (), beg_8.class );
                    itemView.getContext ().startActivity ( intent8 );
                    break;
                case 8:
                    Intent intent9 = new Intent ( itemView.getContext (), beg_9.class );
                    itemView.getContext ().startActivity ( intent9 );
                    break;
                case 9:
                    Intent intent10 = new Intent ( itemView.getContext (), beg_10.class );
                    itemView.getContext ().startActivity ( intent10 );
                    break;
                case 10:
                    Intent intent11 = new Intent ( itemView.getContext (), beg_11.class );
                    itemView.getContext ().startActivity ( intent11 );
                    break;
                case 11:
                    Intent intent12 = new Intent ( itemView.getContext (), beg_12.class );
                    itemView.getContext ().startActivity ( intent12 );
                    break;
                case 12:
                    Intent intent13 = new Intent ( itemView.getContext (), beg_13.class );
