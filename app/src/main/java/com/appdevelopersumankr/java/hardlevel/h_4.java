...
import com.appdevelopersumankr.java.expertlevel.e_1_final;

public class h_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_h_4 );
    ...
    private void startQuiz() {
        Intent intent = new Intent( h_4.this, h_4_final.class);
